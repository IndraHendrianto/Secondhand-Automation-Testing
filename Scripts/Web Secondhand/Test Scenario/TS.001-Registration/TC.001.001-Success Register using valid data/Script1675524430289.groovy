...
WebUI.callTestCase(findTestCase('Test Cases/Web Secondhand/Page/Register page/input user registration data'), [('email'): randomEmail], FailureHandling.STOP_ON_FAILURE)
...
'verify success registration message exist'
WebUI.callTestCase(findTestCase('Test Cases/Web Secondhand/Page/Register page/verify success registration message exist'), null, FailureHandling.STOP_ON_FAILURE)
