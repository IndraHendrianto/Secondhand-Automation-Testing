...
'Reject Product'
WebUI.callTestCase(findTestCase('Test Cases/Web Secondhand/Page/Product/Reject Product'), null, FailureHandling.STOP_ON_FAILURE)

'verify product rejected'
WebUI.callTestCase(findTestCase('Test Cases/Web Secondhand/Page/Product/verify product reject'), null, FailureHandling.STOP_ON_FAILURE)
