...
WebUI.callTestCase(findTestCase('Test Cases/Web Secondhand/Page/Login page/input user login data using wrong password'), [('emailLogin'):('conilex566@quamox.com')], FailureHandling.STOP_ON_FAILURE)
...
'verify alert message wrong password exist'
WebUI.callTestCase(findTestCase('Test Cases/Web Secondhand/Page/Login page/verify alert message wrong password exist'), null, FailureHandling.STOP_ON_FAILURE)
