...
'input cancel product'
Mobile.callTestCase(findTestCase('Test Cases/Mobile Secondhand/Page/Buyer Page/input cancel product'), null, FailureHandling.STOP_ON_FAILURE)
