...
'input new product for bid'
Mobile.callTestCase(findTestCase('Test Cases/Mobile Secondhand/Page/Buyer Page/input new product for bid'), null, FailureHandling.STOP_ON_FAILURE)
