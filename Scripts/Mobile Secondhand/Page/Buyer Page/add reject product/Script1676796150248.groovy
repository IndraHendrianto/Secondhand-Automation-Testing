...
'input new product for reject'
Mobile.callTestCase(findTestCase('Test Cases/Mobile Secondhand/Page/Buyer Page/input reject product'), null, FailureHandling.STOP_ON_FAILURE)
