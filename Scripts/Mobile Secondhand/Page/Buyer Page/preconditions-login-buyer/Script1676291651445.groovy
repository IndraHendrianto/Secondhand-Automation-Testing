...
'input buyer email & password'
Mobile.callTestCase(findTestCase('Test Cases/Mobile Secondhand/Page/Buyer Page/input buyer login data'), null, FailureHandling.STOP_ON_FAILURE)
