...
Mobile.callTestCase(findTestCase('Test Cases/Mobile Secondhand/Page/Register page/input user registration data'), [('email'): randomEmail], FailureHandling.STOP_ON_FAILURE)
