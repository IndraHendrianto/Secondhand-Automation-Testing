...
Mobile.callTestCase(findTestCase('Test Cases/Mobile Secondhand/Page/Register page/input user registration data'), [('email'): ('cobates@mail.com')], FailureHandling.STOP_ON_FAILURE)
...
'verify toast failed register exist'
Mobile.callTestCase(findTestCase('Test Cases/Mobile Secondhand/Page/Register page/verify toast failed register exist'), null, FailureHandling.STOP_ON_FAILURE)
