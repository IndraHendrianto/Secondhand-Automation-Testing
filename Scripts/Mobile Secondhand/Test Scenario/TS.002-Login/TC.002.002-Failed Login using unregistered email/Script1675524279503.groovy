...
Mobile.callTestCase(findTestCase('Test Cases/Mobile Secondhand/Page/Login page/input user login data'), [('emailLogin'):('cobangasal12345@mail.com')], FailureHandling.STOP_ON_FAILURE)
