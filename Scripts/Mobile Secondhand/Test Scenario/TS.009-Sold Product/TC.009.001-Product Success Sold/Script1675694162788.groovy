...
'seller add product'
Mobile.callTestCase(findTestCase('Test Cases/Mobile Secondhand/Page/Buyer Page/add product for bid'), null, FailureHandling.STOP_ON_FAILURE)
...
'search product'
Mobile.callTestCase(findTestCase('Test Cases/Mobile Secondhand/Page/Buyer Page/search product buyer'), null, FailureHandling.STOP_ON_FAILURE)
...
'change status sold product'
Mobile.callTestCase(findTestCase('Test Cases/Mobile Secondhand/Page/Sold Product Page/change status - sold'), null, FailureHandling.STOP_ON_FAILURE)
