...
Mobile.callTestCase(findTestCase('Test Cases/Mobile Secondhand/Page/Login page/input user login data'), [('emailLogin'):('binaracademy')], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Test Cases/Mobile Secondhand/Page/Login page/verify invalid email alert message exist'), null, FailureHandling.STOP_ON_FAILURE)
